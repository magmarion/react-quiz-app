...
const variantStyles = {
  primary: {
    front: 'bg-[#007bff]', // Blue (HSL(212,100%,47%))
  ...
  tertiary: {
    ...
    edge: 'bg-gradient-to-l from-[#663300] via-[#cc6600] to-[#552800]', // Dark orange gradient
  },
};
    ...
    <Link to={to} className="relative group inline-block outline-none focus:outline-offset-4">
      ...
      <span
        className="absolute top-[5px] left-0 w-full h-full rounded-[12px] bg-black/25
                   ...
                   ease-[cubic-bezier(0.3,0.7,0.4,1)] group-hover:translate-y-[4px]
      ...
      <span
        className={`relative block px-6 py-2 rounded-[12px] text-white text-lg font-semibold ${front}
                    will-change-transform translate-y-[-4px] transition-transform duration-[600ms]
                    ease-[cubic-bezier(0.3,0.7,0.4,1)] group-hover:translate-y-[-6px]
